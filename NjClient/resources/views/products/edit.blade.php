  ...
  <html lang="en">
    ...
    <body>
      <div class="bg-dark py-3">
        <h3 class="text-white text-center">Simp1e Laravel 11 CRUD</h3>
      </div>
      <div class="container">
                    ...
                    @csrf
                      <div class="card-body">
                          ...
                          <div class="mb-3">
                              ...
                              <textarea class="form-control" name= "description" placeholder="Description" value="{{old('description', $product->description)}}" cols="30" rows="5"></textarea>
                          </div>
                          <div class="mb-3">
                              <label for="" class="form-lable h5">Image</label>
                              <input type="file" class="form-control form-control-lg" placeholder="Image" name="image">
                              @if ($product->image != "")
                          <img class="w-50 my-2" src="{{asset('upload/products/'.$product->image)}}", alt="">
                       @endif
                          </div>
                          <div class="d-grid">
